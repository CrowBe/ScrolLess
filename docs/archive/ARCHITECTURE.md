> Historical snapshot before issue #81. Superseded as target guidance by [Architecture](../ARCHITECTURE.md) and [Runtime contract](../RUNTIME_CONTRACT.md). This records old behavior and plans, not a supported personal-host deployment. Verify operational details against code.
