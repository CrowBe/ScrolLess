...
The [historical snapshot](archive/EXPO_REFACTOR_PLAN.md) preserves the former design; existing code may still implement parts of it. Superseded does not mean implemented or removed.
