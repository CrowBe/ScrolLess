...
The [historical snapshot](archive/TIER_CONTRACT.md) preserves the former design; existing code may still implement parts of it. Superseded does not mean implemented or removed.
